...
if Utils.isDesktop() and not Utils.isLocalUrl(document.URL)
	...
	controlPanel.noti.longLooks.buttonsLabel = createPanelButton 
		x: controlPanel.noti.longLooks.buttonsdefault.maxX + SPACE.HO y: controlPanel.noti.longLooks.attach.maxY + SPACE.VERTICAL.INNER
		html: "버튼명"
		parent: controlPanel
	# 알림 : Long looks : 버튼명
	controlPanel.noti.longLooks.buttonsLabel = createPanelButton 
	...
	controlPanel.clockface = new Layer
		y: controlPanel.noti.longLooks.buttons.maxY + SPACE.VERTICAL.PANEL
		html: "시계화면 변경하기"
		style:
			fontSize: "50px", fontWeight: "600"
			lineHeight: "1"
	...
	controlPanel.noti.longLooks.buttons.onClick -> controlPanel.emit Noti.LongLooks.Buttons, @
